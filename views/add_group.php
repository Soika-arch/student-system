...
<?php $sql = "SELECT teachers.id, teachers.surname FROM teachers";
$Data["teachers"] = db_query($sql); ?>

<h3>Додати до бази нову групу: </h3>
<form action="<?php echo WWW ."/add_group" ?>" method="POST" class="add-group">
	<div class="form-group row">
		<label for="inputEmail3" class="col-sm-2 col-form-label">Шифр групи</label>
		<div class="col-sm-2">
			<input type="text" name="cipher" class="form-control" id="inputEmail3" placeholder="">
		</div>
	</div>
	...
	<div class="form-group row">
		...
		<div class="col-sm-2">
			<select name="teacherGroup" id="inputTeacher" class="form-control">
